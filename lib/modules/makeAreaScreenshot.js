    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 19:
          ...
          _context4.next = 23;
          return _regenerator2.default.awrap(browser.execute(_virtualScroll2.default, x, y, options));
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 3:
                    ...
                    _context3.next = 6;
                    return _regenerator2.default.awrap(browser.execute(_virtualScroll2.default, 0, 0, options));
